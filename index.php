                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <h1 style="color:#003300 ; font-size:38px ;" ><strong>Technical Events</strong></h1><!--title-->
                            <p><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong>Gaming Events</strong></h1><!--title-->
                            <p><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong>On-Stage Events</strong></h1><!--title-->
                            <p><!--content-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong>Off-Stage Events</strong></h1><!--title-->
                            <p><!--content-->
